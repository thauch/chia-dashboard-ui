...
@Component({
  selector: 'app-farm-summary-flax',
  templateUrl: './farm-summary-flax.component.html',
  styleUrls: ['./farm-summary-flax.component.scss']
})
export class FarmSummaryFlaxComponent implements OnInit {
  ...
  get dailyRewardXch() {
    ...
    return `≈ ${dailyReward.toFixed(2)} FLAX`;
  }
