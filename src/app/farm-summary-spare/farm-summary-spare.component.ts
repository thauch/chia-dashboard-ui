...
@Component({
  selector: 'app-farm-summary-spare',
  templateUrl: './farm-summary-spare.component.html',
  styleUrls: ['./farm-summary-spare.component.scss']
})
export class FarmSummarySpareComponent implements OnInit {
  ...
  get dailyRewardXch() {
    ...
    return `≈ ${dailyReward.toFixed(2)} SPARE`;
  }
