...
@Component({
  selector: 'app-hpool-dashboard',
  templateUrl: './hpool-dashboard.component.html',
  styleUrls: ['./hpool-dashboard.component.scss']
})
export class HPoolDashboardComponent implements OnInit {
  ...
  get hpoolMiners() {
    return this.stateService.hpoolMiners;
  }
