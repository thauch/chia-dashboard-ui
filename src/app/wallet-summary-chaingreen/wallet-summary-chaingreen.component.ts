...
@Component({
  selector: 'app-wallet-summary-chaingreen',
  templateUrl: './wallet-summary-chaingreen.component.html',
  styleUrls: ['./wallet-summary-chaingreen.component.scss']
})
export class WalletSummaryChaingreenComponent implements OnInit {
  @Input() wallets: any;
