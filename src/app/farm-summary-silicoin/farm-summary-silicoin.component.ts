...
@Component({
  selector: 'app-farm-summary-silicoin',
  templateUrl: './farm-summary-silicoin.component.html',
  styleUrls: ['./farm-summary-silicoin.component.scss']
})
export class FarmSummarySilicoinComponent implements OnInit {
  ...
  get dailyRewardXch() {
    ...
    return `≈ ${dailyReward.toFixed(2)} SIT`;
  }
