...
@Component({
  selector: 'app-wallet-summary-spare',
  templateUrl: './wallet-summary-spare.component.html',
  styleUrls: ['./wallet-summary-spare.component.scss']
})
export class WalletSummarySpareComponent implements OnInit {
  @Input() wallets: any;
