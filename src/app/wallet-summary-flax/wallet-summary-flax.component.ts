...
@Component({
  selector: 'app-wallet-summary-flax',
  templateUrl: './wallet-summary-flax.component.html',
  styleUrls: ['./wallet-summary-flax.component.scss']
})
export class WalletSummaryFlaxComponent implements OnInit {
  @Input() wallets: any;
