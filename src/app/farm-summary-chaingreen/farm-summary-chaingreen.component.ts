...
@Component({
  selector: 'app-farm-summary-chaingreen',
  templateUrl: './farm-summary-chaingreen.component.html',
  styleUrls: ['./farm-summary-chaingreen.component.scss']
})
export class FarmSummaryChaingreenComponent implements OnInit {
