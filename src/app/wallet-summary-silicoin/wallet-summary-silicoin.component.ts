...
@Component({
  selector: 'app-wallet-summary-silicoin',
  templateUrl: './wallet-summary-silicoin.component.html',
  styleUrls: ['./wallet-summary-silicoin.component.scss']
})
export class WalletSummarySilicoinComponent implements OnInit {
  @Input() wallets: any;
